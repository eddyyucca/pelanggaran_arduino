	...
	<table class="table-bordered" style="width: 100%">
		...
		<tbody>
			 <?php 
				$no=0;
				$data=$this->db->query(
					"SELECT * from tb_pelanggaran where tgl BETWEEN '$Dari' AND '$Sampai' order by pelanggaran_id desc");
			...
			<tr>
				...
				<td colspan="4" style="text-align: center;vertical-align: middle;"> <?php echo '<img width="150" height="150" src="data:image/jpeg/jpg/png;base64,'.base64_encode( $i['foto'] ).'"/>'?></td>
			</tr>
			<?php endforeach;?>
		</tbody>	
	</table>
