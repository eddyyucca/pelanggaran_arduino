...
class Administrator extends CI_Controller
{
    ...
    function auth()
    {
        ...
        $password = strip_tags(str_replace("'", "", md5($this->input->post('password', TRUE))));
    ...
    function gagallogin()
    {
        ...
        echo $this->session->set_flashdata('msg', '<div class="alert alert-danger" role="alert"><button type="button" class="close"
            data-dismiss="alert"><span class="fa fa-close"></span></button>Username atau Password Salah</div>');
        redirect($url);
    }
    function logout()
    {
